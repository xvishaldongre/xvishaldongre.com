...
export function remarkCodeSnippets() {
    const visitor = (code, index, parent) => {
 ...
 */
function preprocessCode(code, lang, extractFileName) {
    let extractedFileName;
    let removedLineIndex;
...
export function encodeMarkdownStringProp(input) {
...
export function encodeMarkdownStringArrayProp(arrInput) {
 ...
 */
export function astroCodeSnippets() {
    return {
