...
export class ShikiLine {
    ...
    constructor(highlightedCodeLine) {
    ...
    getInlineMarkingDefinitionMatches(inlineMarking) {
        const markedRanges = [];
    ...
    textPositionToTokenPosition(textPosition) {
    ...
    insertMarkerTokenAtPosition(position, markerToken) {
    ...
    flattenMarkedRanges(markedRanges) {
